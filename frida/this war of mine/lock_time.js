function hook1(){
        ...
        var fun_name_str = "_ZNK21KosovoCurrentDateTime10GetDayTimeERjS0_";
...
function test(){
        ...
        if(fun_addr != null){
                Interceptor.attach(fun_addr,{
                        onEnter:function(args){
                                var call_native_fun_str = "_ZN11KosovoScene6OnTickEv";
                                ...
                                var call_native_fun = new NativeFunction(call_native_fun_addr , 'pointer', ['pointer']);
                                call_native_fun(gKosovoScene);
